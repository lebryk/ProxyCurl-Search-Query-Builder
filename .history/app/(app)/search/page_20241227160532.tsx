...
export default function SearchQueryBuilderPage() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      queryClient.setQueryData(['searchResults'], searchResults);
      ...
      <div className={`flex-1 h-full transition-all duration-400 ${isChatOpen ? 'mr-[450px]' : 'mr-0'}`}>
        <div className="container mx-auto p-6 space-y-8">
            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                <QueryInputs 
                  ...
                  query={query} 
                  updateQuery={updateQuery as (field: string | number | symbol, value: string | number | string[]) => void}
                  onOpenBooleanBuilder={openBooleanBuilder as (field: string | number | symbol) => void}
                />
          ...
          <QueryModal 
            ...
            onAdd={addFields as (fields: (string | number | symbol)[]) => void}
            selectedFields={selectedFields}
          />
