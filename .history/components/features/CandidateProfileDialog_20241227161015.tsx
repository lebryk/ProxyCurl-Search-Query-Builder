      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-hidden p-0">
        ...
        <ScrollArea className="h-[calc(90vh-180px)]">
          <div className="p-6 space-y-8">
            ...
            {((profile.languages?.length || 0) > 0 || (profile.certifications?.length || 0) > 0) && (
              <>
                <Separator />
            ...
            {(
              (profile.accomplishment_organisations?.length || 0) > 0 ||
              (profile.accomplishment_publications?.length || 0) > 0 ||
              (profile.accomplishment_honors_awards?.length || 0) > 0 ||
              (profile.accomplishment_patents?.length || 0) > 0 ||
              (profile.accomplishment_courses?.length || 0) > 0 ||
              (profile.accomplishment_test_scores?.length || 0) > 0
            ) && (
              <>
                <Separator />
            ...
            {(profile.accomplishment_projects?.length || 0) > 0 && (
              <>
                <Separator />
