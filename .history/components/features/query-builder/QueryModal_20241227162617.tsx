              ...
              <Card key={group} className="overflow-hidden">
                ...
                <CardContent className="p-4">
                  <div className="space-y-2">
                    {fields.map((field) => (
                      <div key={String(field.name)} className="flex items-center space-x-2">
                        <Checkbox
                          id={String(field.name)}
                          checked={selectedItems.has(field.name as keyof PeopleSearchQueryParams)}
                          onCheckedChange={() => handleCheckboxChange(field.name as keyof PeopleSearchQueryParams)}
                        />
