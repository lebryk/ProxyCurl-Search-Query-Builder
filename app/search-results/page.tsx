...
const SearchResults = () => {
  ...
  const selectedCandidateIds = shortlistedCandidates.map(c => c.id);

  console.log("SearchResults render - Active Project:", activeProject);
  console.log("SearchResults render - Candidates:", candidates);
  console.log("SearchResults render - Loading:", isLoading);
  console.log("SearchResults render - Error:", error);
